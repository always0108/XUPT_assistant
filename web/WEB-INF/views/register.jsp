...
<div >
    <div class="login" style="display: block;height: 450px">
        ...
        <div class="login-center clearfix">
            <div class="login-center-img"><img src="../../resource/login/images/password.png"></div>
            <div class="login-center-input">
                <input type="password" name="repassword" id="repassword" value="" placeholder="请再次输入您的密码" onfocus="this.placeholder=&#39;&#39;" onblur="this.placeholder=&#39;请再次输入您的密码&#39;">
                <div class="login-center-input-text">密码</div>
            </div>
        </div>
        ...
        <div class="login-button" style="margin-top: 20px" id="backButton">
            返回
        </div>
    </div>
